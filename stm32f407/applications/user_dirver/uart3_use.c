...
//        return RT_ERROR;
//    
//    return rt_device_write(serial3, 0, data,len);
//}

//int Uart3_Read(unsigned char* data,unsigned int *len)
//{
//    if(serial3 == RT_NULL)
//    {
//        return RT_ERROR;
...
//    
//    /* 打开设备 */
//    ret = rt_device_open(serial3,RT_DEVICE_FLAG_DMA_RX);
//    
//    if(ret != RT_EOK)
//        return ret;
//    
//    /* 设置接收回调函数 */
//    rt_mq_init(&rx_mq, "rx_mq3",
//               msg_pool,                 /* 存放消息的缓冲区 */
...
//    
//    //Uart3_Wirte((unsigned char *)"uart3 test\n",sizeof("uart3 test\n")-1);
//    
//    return RT_EOK;
//}
