...
//        return RT_ERROR;
//    
//    return rt_device_write(serial6, 0, data,len);
//}

//int Uart6_Read(unsigned char* data,unsigned int *len)
//{
//    if(serial6 == RT_NULL)
//    {
//        return RT_ERROR;
...
//    int ret = 0;
//    /* 查找串口设备 */
//    serial6 = rt_device_find(SAMPLE_UART6_NAME);
//    
//    if(serial6 == RT_NULL)
//    {
//        return RT_ERROR;
...
//    
//    /* 打开设备 */
//    ret = rt_device_open(serial6,RT_DEVICE_FLAG_DMA_RX);
//    
//    if(ret != RT_EOK)
//        return ret;
//    
//    /* 设置接收回调函数 */
//    rt_mq_init(&rx_mq, "rx_mq6",
//               msg_pool,                 /* 存放消息的缓冲区 */
//               sizeof(struct rx_msg),    /* 一条消息的最大长度 */
//               sizeof(msg_pool),         /* 存放消息的缓冲区大小 */
//               RT_IPC_FLAG_FIFO);        /* 如果有多个线程等待，按照先来先得到的方法分配消息 */
//    rt_device_set_rx_indicate(serial6, uart_input);
//    
//    //Uart6_Wirte((unsigned char *)"uart6 test\n",sizeof("uart6 test\n")-1);
//    
//    return RT_EOK;
//}
