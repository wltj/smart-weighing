...
//}
//
//int http_ota_fw_download(const char* uri,unsigned char type)
//{
...
//    {
//        /* term firmware */
//        if ((dl_part = fal_partition_find("term_up")) == RT_NULL)
//        {
//            LOG_E("Firmware download failed! Partition (%s) find error!", "download");
//            ret = -RT_ERROR;
//            goto __exit;
...
////}
//
//void http_ota_handle(char* url,unsigned char type)
//{
//    http_ota_fw_download(url,type);
//}
///**
// * msh />http_ota [url]
//*/
