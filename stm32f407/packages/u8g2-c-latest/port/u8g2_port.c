...
uint8_t u8x8_rt_gpio_and_delay(u8x8_t *u8x8, uint8_t msg, uint8_t arg_int, void *arg_ptr)
{
    switch(msg)
    {
        ...
        case U8X8_MSG_GPIO_AND_DELAY_INIT:  
            ...
            rt_pin_mode(u8x8->pins[U8X8_PIN_MENU_SELECT],PIN_MODE_INPUT);
            rt_pin_mode(u8x8->pins[U8X8_PIN_MENU_NEXT],PIN_MODE_INPUT);
            rt_pin_mode(u8x8->pins[U8X8_PIN_MENU_PREV],PIN_MODE_INPUT);
            rt_pin_mode(u8x8->pins[U8X8_PIN_MENU_HOME],PIN_MODE_INPUT);
            rt_pin_mode(u8x8->pins[U8X8_PIN_MENU_UP],PIN_MODE_INPUT);
            rt_pin_mode(u8x8->pins[U8X8_PIN_MENU_DOWN],PIN_MODE_INPUT);
      ...
      break;
        ...
        case U8X8_MSG_GPIO_MENU_SELECT:
            u8x8->gpio_result = rt_pin_read(u8x8->pins[U8X8_PIN_MENU_SELECT]);
            break;
        
        case U8X8_MSG_GPIO_MENU_NEXT:
            u8x8->gpio_result = rt_pin_read(u8x8->pins[U8X8_PIN_MENU_NEXT]);
            break;
        
        case U8X8_MSG_GPIO_MENU_PREV:
            u8x8->gpio_result = rt_pin_read(u8x8->pins[U8X8_PIN_MENU_PREV]);
            break;
        
        case U8X8_MSG_GPIO_MENU_HOME:
            u8x8->gpio_result = rt_pin_read(u8x8->pins[U8X8_PIN_MENU_HOME]);
            break;
        
        case U8X8_MSG_GPIO_MENU_UP:
            u8x8->gpio_result = rt_pin_read(u8x8->pins[U8X8_PIN_MENU_UP]);
            break;
        
        case U8X8_MSG_GPIO_MENU_DOWN:
            u8x8->gpio_result = rt_pin_read(u8x8->pins[U8X8_PIN_MENU_DOWN]);
            break;
